var ToDo = function (rootElementAll, rootElementActive, rootElementCompleted) {
    ...
    // TEMPLATE LITERALS - omogucava definisanje bez konkatenacije primenom ovih kosih navodnika
...
`;
    ...
    function generateToDoItemView(toDoItem) {
        ...
        // kreiramo root element i dodajemo mu sadrzaj koji se definise u item template-u
        ...
        //Proverava se da li  je stavka kompletirana za slucaj da dolazi iz neke baze, iako je za rucne unose defaul false;
        toDoItemRoot.classList.add(toDoItem.completed ? "completed" : null);

        //Obavlja se kloniranje dom elementa kako bi smo od svake stavke imali dva dom elementa.
        //Prva ide u prvi tab gde su All-item
        // Dok druga ide u zavisnosti od toga da li je kompletirana ili je u toku
        let toDoItemRootCopy = toDoItemRoot.cloneNode(true);

        //Prvi element se svakako dodaje u prvi tab
        rootElementAll.append(toDoItemRoot);

        //Ovde pravimo logiku koja smesta drugi dom element u aktivan ili kompletiran sadrzaj.
    ...
    //Primer closure-a
    //Ukoliko ne stavimo u zagradi content na html-u u browseru je ispis [object HTMLInputElement] umesto teksta ispisa;
    return {
